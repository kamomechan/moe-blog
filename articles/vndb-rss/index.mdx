...
export const metadata = {
  title: "vndb-rss",
  date: "2025-06-01",
  description: "VNDB API-based RSS Feed for Recent Releases of visual novels",
  edit: "2025-11-21",
};
...
[VNDB RSS](https://codeberg.org/nokutan/vndb-rss) 订阅服务，通过调用 [vndb-api](https://api.vndb.org/kana) 获取数据，用来追踪最近发布的视觉小说，并进行格式化显示
...
<Image src={i5} alt="screenshort" />
<Image src={i6} alt="screenshort" />
